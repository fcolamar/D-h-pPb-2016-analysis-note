...
{\includegraphics[width=.32\linewidth]{figures/DplusPlotsweff/InvMassDistributions_Dplus_Bins3to4.png.png}}
{\includegraphics[width=.32\linewidth]{figures/DplusPlotsweff/InvMassDistributions_Dplus_Bins5to7.png.png}}
{\includegraphics[width=.32\linewidth]{figures/DplusPlotsweff/InvMassDistributions_Dplus_Bins8to10.png.png}}
{\includegraphics[width=.32\linewidth]{figures/DplusPlotsweff/InvMassDistributions_Dplus_Bins11to11.png.png}}
...
\begin{figure}[h]
\centering 
\includegraphics[width=1\linewidth]{{figures/Dzero/h1D_Dzero_Canvas_Normalized_PtIntBins9to11_PoolInt_thr0dot3to99dot0.png}}
\includegraphics[width=1\linewidth, height = 7cm]{{figures/Dzero/h1D_Dzero_Canvas_PtIntBins9to11_PoolInt_thr1dot0to99dot0.png}}
\caption{Top:  signal region per-trigger normalized correlation distribution (blue), sideband region per-trigger normalized correlation distribution (red),
signal subtracted of background per-trigger normalized correlation distribution (black). Bottom: Signal region not normalized of correlation distribution (left), sideband region not normalized of correlation distribution (middle), signal region after sideband subtracted correlation distribution (right).}
