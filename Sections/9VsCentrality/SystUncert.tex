...
A table summarizing the systematic uncertainties on the $\Delta\varphi$ correlation distribution for the $\Dzero$ meson is shown in Fig. {\bf REF}, for the $\Dstar$ meson is shown in Fig.{\ref{fig:TableSystDstar}}

\begin{figure}
\centering
{\includegraphics{figuresVsCent/Dstar/DstarSystematics.pdf}}
