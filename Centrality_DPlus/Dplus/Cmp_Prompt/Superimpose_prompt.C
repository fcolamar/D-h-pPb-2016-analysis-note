...
void DoAllPlotsin1Canvas(){
  ...
  /*  grAS1[2]->SetMarkerSize(1.2);
    ...
    leg_hist1->AddEntry(grAS1[0],"V0A: 60_100 %","p");
    leg_hist1->AddEntry(grAS1[1],"ZNA: 60_100 %","p");
...
void LoadFileNamespPbDMeson(){
            filenames[0] += "./V0A/FDIngradients_60_100/fPrompt_Final_Nb.root";
            filenames[1] += "./ZNA/60_100/FDIngradients/fPrompt_Final_Nb.root";
           // filenames[2] += "./60_100/FDIngradients/fPrompt_Final_Nb.root";
           // filenames[3] += "./60_100/FDIngradients/fPrompt_Final_Nb.root";
}
